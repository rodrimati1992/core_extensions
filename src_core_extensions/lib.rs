...
//! Can be stored in any data type without changing its layout.
//! 
//! ## Other traits
//! 
...
pub use self::callable::{CallRef,CallMut,CallInto};
#[doc(inline)]
...
#[doc(inline)]
pub use self::marker_traits::{
    MarkerType,
};
pub use self::transparent_newtype::{
    TransparentNewtype,
};
#[doc(inline)]
pub use self::type_identity::{TypeIdentity,TIdentity};
